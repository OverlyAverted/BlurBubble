# 📜 Copyright, Inventorship, & Dual-Licensing Declaration

**Document Reference: BB-OVP-2026-002**  
...
## 🏛️ Open Source & Licensing Strategy (GPLv3 Dual-License Model)

To encourage global adoption, foster community safety, and establish BlurBubble as the standard spatial privacy protocol, this project is licensed under a **Dual-License Strategy**:

### 1. Open Source Copyleft Option (GNU GPLv3)
The entire software codebase, including simulators, cryptographic designs, and canvas telemetry engines, is freely accessible under the **GNU General Public License Version 3 (GPLv3)**:
- **Freedom to Fork & Modify:** Developers, researchers, and privacy advocates are granted non-exclusive, worldwide, royalty-free permissions to clone, modify, study, and distribute this software.
- **Copyleft Enforcement:** Any downstream derivative work, application, or software package that incorporates BlurBubble source code MUST also be released under the GPLv3 license. This ensures no corporate entity can lock up public improvements.
